...
public class FournisseurController {
	...
	public String fournisseur(Model model) {
		List<Fournisseur> fournisseurs = fournisseurService.findByAll();
	...
	// fait appel au formulaire d'ajout d'un fournisseur
	...
	public String enregisterFournisseur(Model model, Fournisseur fournisseur, MultipartFile file) {
		...
		return "redirect:/fournisseur/";// fait une redirection
	}
	...
	public String modifierFournisseur(Model model, @PathVariable Long idFournisseur) {
		...
		if(idFournisseur!=null) {
			Fournisseur fournisseur=fournisseurService.findByd(idFournisseur);
			if(fournisseur!=null) {
				model.addAttribute("fournisseur", fournisseur);
			}
		}
	...
	public String supprimerFournisseur(Model model, @PathVariable Long idFournisseur) {
		...
		if(idFournisseur!=null) {
			Fournisseur fournisseur=fournisseurService.findByd(idFournisseur);
			if(fournisseur!=null) {
				//Verification avant suppression.Impossible de supprimer un fournisseur qui à deja des commandes
