...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><spring:message code="common.utilisateur.nouveau"></spring:message></h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<spring:message code="common.utilisateur.nouveau"></spring:message>
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<c:url value="/utilisateur/enregistrer" var="urlEnregistrer"/>
							<f:form modelAttribute="utilisateur" action='${urlEnregistrer}' enctype="multipart/form-data" role="form">
								...
								<div class="form-group">
									<label><spring:message code="common.motDePasse"></spring:message></label> 
								...
								<a href="<c:url value="/utilisateur/"/>" class="btn btn-danger"><i class="fa fa-arrow-left">&nbsp;<spring:message code="common.annuler"></spring:message></i></a>
								</div>
							</f:form>
						</div>
						<!-- /.panel-body -->
