...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><fmt:message key="common.utilisateur.nouveau"></fmt:message></h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<fmt:message key="common.utilisateur.nouveau"></fmt:message>
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							...
							<f:form modelAttribute="utilisateur" action='${urlEnregistrer}' enctype="multipart/form-data" role="form">
								...
								<div class="form-group">
									<label><fmt:message key="common.motDePasse"></fmt:message></label> 
								...
								<a href="<c:url value="/utilisateur/"/>" class="btn btn-danger"><i class="fa fa-arrow-left">&nbsp;<fmt:message key="common.annuler"></fmt:message></i></a>
								</div>
							</f:form>
						</div>
						<!-- /.panel-body -->
