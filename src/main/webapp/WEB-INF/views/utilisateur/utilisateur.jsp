...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><spring:message code="common.parametrage.utilisateur"/></h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class="row">
			<div class="col-lg-12">
			<ol class="breadcrumb">
			<li><a href="<c:url value="/utilisateur/nouveau"/>" ><i class="fa fa-plus">&nbsp;<spring:message code="common.ajouter"></spring:message></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <spring:message code="common.utilisateur.liste"></spring:message>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><spring:message code="common.motDePasse"></spring:message></th>
                                    ...
                                    <tr class="odd gradeX">
                                            <td><img src="${utilisateur.getPhoto()}" width="90px" height="90px"/></td>
                                            <td>${utilisateur.getNom()}</td>
                                            <td>${utilisateur.getPrenom()}</td>
                                            <td class="center">${utilisateur.getMotDePasse()}</td>
                                            <td class="center">${utilisateur.getMail()}</td>
                                            <td>
                                            <c:url value="/utilisateur/modifier/${utilisateur.getIdUtilisateur()}" var="urlModifier"/>
                                            <a href="${urlModifier}"><i class="fa fa-edit"></i></a>
                                            &nbsp;|&nbsp;
                                            <a href="javascript:void(0);" data-toggle="modal" data-target="#modalUtilisateur${utilisateur.getIdUtilisateur()}"><i class="fa fa-trash-o"></i></a>                                           
						                         <div class="modal fade" id="modalUtilisateur${utilisateur.getIdUtilisateur()}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						                             <div class="modal-dialog">
						                                 <div class="modal-content">
						                                     ...
						                                     <spring:message code="common.utilisateur.confirmer.suppression.msg"/>
						                                     </div>
