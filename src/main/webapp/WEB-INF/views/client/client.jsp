...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="col-lg-12">
			<ol class="breadcrumb">
			<li><a href="<c:url value="/client/nouveau"/>" ><i class="fa fa-plus">&nbsp;<fmt:message key="common.ajouter"></fmt:message></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message key="common.client.liste"></fmt:message>
                        </div>
                        <!-- /.panel-heading -->
						                         ...
						                         <div class="modal fade" id="modalClient${client.getIdClient()}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						                             <div class="modal-dialog">
						                                 <div class="modal-content">
						                                     ...
						                                     <fmt:message key="common.client.confirmer.suppression.msg"/>
						                                     </div>
