...
<title><fmt:message key="common.titre"></fmt:message></title>
...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header"><fmt:message key="common.categorie"/></h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class="row">
			<div class="col-lg-12">
			<ol class="breadcrumb">
			<li><a href="<c:url value="/categorie/nouveau"/>" ><i class="fa fa-plus">&nbsp;<fmt:message key="common.ajouter"></fmt:message></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message key="common.categorie.liste"></fmt:message>
                        </div>
                        <!-- /.panel-heading -->
						                         ...
						                         <div class="modal fade" id="modalCategorie${categorie.getIdCategorie()}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						                             <div class="modal-dialog">
						                                 <div class="modal-content">
						                                     ...
						                                     <fmt:message key="common.categorie.confirmer.suppression.msg"/>
						                                     </div>
